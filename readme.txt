=== Custom Functions Starter Kit by DraftPress ===
...
2. Search for `Custom Functions Starter Kit` and install it.
...
1. Custom Functions Starter Kit General WordPress Functions
...
= 2.0.1 = 2015-10-21
* FIXED: Script format was not compatible with certain WordPress installs
